...
export const threads = pgTable(
	...
	(table) => [
		index("threads_mailbox_last_message_at_idx").on(
			table.mailboxId,
			table.lastMessageAt,
		),
	],
...
export const messages = pgTable(
	...
	(table) => [
		...
		index("messages_mailbox_sent_at_idx").on(table.mailboxId, table.sentAt),
	],
);
...
export const messageRecipients = pgTable(
	...
	(table) => [
		primaryKey({ columns: [table.messageId, table.type, table.address] }),
		index("message_recipients_address_idx").on(table.address),
	],
);
